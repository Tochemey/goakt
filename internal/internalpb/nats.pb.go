...
var file_internal_nats_proto_rawDesc = []byte{
	...
	0x10, 0x03, 0x42, 0x9f, 0x01, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x2e, 0x69, 0x6e, 0x74, 0x65, 0x72,
...
var file_internal_nats_proto_goTypes = []interface{}{
...
func file_internal_nats_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internal_nats_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
