...
var file_internal_peers_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x52, 0x65, 0x66, 0x52, 0x06, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x42, 0xa3,
...
var file_internal_peers_proto_goTypes = []any{
	...
	(*ActorRef)(nil),  // 2: internalpb.ActorRef
}
var file_internal_peers_proto_depIdxs = []int32{
	2, // 0: internalpb.PeersSync.actor:type_name -> internalpb.ActorRef
	2, // 1: internalpb.PeerState.actors:type_name -> internalpb.ActorRef
