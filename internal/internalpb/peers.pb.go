...
var file_internal_peers_proto_goTypes = []any{
	...
	(*ActorRef)(nil),          // 4: internalpb.ActorRef
}
var file_internal_peers_proto_depIdxs = []int32{
	4, // 0: internalpb.PeersSync.actor:type_name -> internalpb.ActorRef
	4, // 1: internalpb.PeerState.actors:type_name -> internalpb.ActorRef
