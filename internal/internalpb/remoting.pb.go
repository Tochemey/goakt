...
const file_internal_remoting_proto_rawDesc = "" +
	...
	"internalpb\x1a\x11goakt/goakt.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x19internal/dependency.proto\x1a\x14internal/grain.proto\"\x8b\x01\n" +
...
var file_internal_remoting_proto_goTypes = []any{
	...
	(*Dependency)(nil),                 // 20: internalpb.Dependency
	(*Grain)(nil),                      // 21: internalpb.Grain
	(*GrainId)(nil),                    // 22: internalpb.GrainId
}
var file_internal_remoting_proto_depIdxs = []int32{
	...
	17, // 8: internalpb.RemoteSpawnRequest.passivate_after:type_name -> google.protobuf.Duration
	20, // 9: internalpb.RemoteSpawnRequest.dependencies:type_name -> internalpb.Dependency
	21, // 10: internalpb.RemoteMessageGrainRequest.grain:type_name -> internalpb.Grain
	22, // 11: internalpb.RemoteMessageGrainRequest.sender:type_name -> internalpb.GrainId
	...
	20, // 14: internalpb.RemoteMessageGrainRequest.dependencies:type_name -> internalpb.Dependency
