...
mock:
    ...
    RUN mockery  --dir internal/peers --name IService --filename peers_service.go --keeptree --exported=true --with-expecter=true --inpackage=true --disable-version-string=true --output ./mocks/cluster --case snake
