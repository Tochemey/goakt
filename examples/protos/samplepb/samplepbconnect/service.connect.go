...
const (
	...
	// CreateAccount RPC.
	AccountServiceCreateAccountProcedure = "/samplepb.AccountService/CreateAccount"
	// AccountServiceCreditAccountProcedure is the fully-qualified name of the AccountService's
	// CreditAccount RPC.
	AccountServiceCreditAccountProcedure = "/samplepb.AccountService/CreditAccount"
...
type AccountServiceClient interface {
	...
	CreditAccount(context.Context, *connect.Request[samplepb.CreditAccountRequest]) (*connect.Response[samplepb.CreditAccountResponse], error)
	GetAccount(context.Context, *connect.Request[samplepb.GetAccountRequest]) (*connect.Response[samplepb.GetAccountResponse], error)
}

// NewAccountServiceClient constructs a client for the samplepb.AccountService service. By default,
...
type accountServiceClient struct {
	createAccount *connect.Client[samplepb.CreateAccountRequest, samplepb.CreateAccountResponse]
	creditAccount *connect.Client[samplepb.CreditAccountRequest, samplepb.CreditAccountResponse]
	getAccount    *connect.Client[samplepb.GetAccountRequest, samplepb.GetAccountResponse]
}

// CreateAccount calls samplepb.AccountService.CreateAccount.
func (c *accountServiceClient) CreateAccount(ctx context.Context, req *connect.Request[samplepb.CreateAccountRequest]) (*connect.Response[samplepb.CreateAccountResponse], error) {
	return c.createAccount.CallUnary(ctx, req)
}

// CreditAccount calls samplepb.AccountService.CreditAccount.
func (c *accountServiceClient) CreditAccount(ctx context.Context, req *connect.Request[samplepb.CreditAccountRequest]) (*connect.Response[samplepb.CreditAccountResponse], error) {
	return c.creditAccount.CallUnary(ctx, req)
}

// GetAccount calls samplepb.AccountService.GetAccount.
func (c *accountServiceClient) GetAccount(ctx context.Context, req *connect.Request[samplepb.GetAccountRequest]) (*connect.Response[samplepb.GetAccountResponse], error) {
...
func (UnimplementedAccountServiceHandler) CreateAccount(context.Context, *connect.Request[samplepb.CreateAccountRequest]) (*connect.Response[samplepb.CreateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("samplepb.AccountService.CreateAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) CreditAccount(context.Context, *connect.Request[samplepb.CreditAccountRequest]) (*connect.Response[samplepb.CreditAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("samplepb.AccountService.CreditAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) GetAccount(context.Context, *connect.Request[samplepb.GetAccountRequest]) (*connect.Response[samplepb.GetAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("samplepb.AccountService.GetAccount is not implemented"))
}
