...
var file_test_test_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x74, 0x65, 0x42, 0x80, 0x01, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x2e, 0x74, 0x65, 0x73,
	0x74, 0x70, 0x62, 0x42, 0x09, 0x54, 0x65, 0x73, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x48, 0x02,
	...
	0x2f, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x3b, 0x74, 0x65, 0x73, 0x74, 0x70,
...
var file_test_test_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
...
func file_test_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_test_test_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_test_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_test_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_test_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_test_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Ping); i {
			case 0:
				return &v.state
			case 1:
		...
		file_test_test_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pong); i {
			case 0:
				return &v.state
			case 1:
		...
		file_test_test_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Wait); i {
			case 0:
				return &v.state
			case 1:
		...
		file_test_test_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_test_test_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
