...
const file_test_test_proto_rawDesc = "" +
	...
	"\bpriority\x18\x02 \x01(\x03R\bpriority\"\"\n" +
	"\fHelloRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2I\n" +
	"\fHelloService\x129\n" +
	"\bSayHello\x12\x14.testpb.HelloRequest\x1a\x15.testpb.HelloResponse\"\x00B\x87\x01\n" +
	"\n" +
	"com.testpbB\tTestProtoH\x02P\x01Z4github.com/tochemey/goakt/v3/test/data/testpb;testpb\xa2\x02\x03TXX\xaa\x02\x06Testpb\xca\x02\x06Testpb\xe2\x02\x12Testpb\\GPBMetadata\xea\x02\x06Testpbb\x06proto3"
...
var file_test_test_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_test_test_proto_goTypes = []any{
	...
	(*HelloRequest)(nil),       // 34: testpb.HelloRequest
	(*HelloResponse)(nil),      // 35: testpb.HelloResponse
	(*anypb.Any)(nil),          // 36: google.protobuf.Any
}
var file_test_test_proto_depIdxs = []int32{
	36, // 0: testpb.TestMessage.message:type_name -> google.protobuf.Any
	34, // 1: testpb.HelloService.SayHello:input_type -> testpb.HelloRequest
	35, // 2: testpb.HelloService.SayHello:output_type -> testpb.HelloResponse
