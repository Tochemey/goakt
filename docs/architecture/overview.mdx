...
| **Context pools** | [Context Pools](/architecture/context-pools)     | Sharded lock-free `ReceiveContext` / `GrainContext` recycling, MPMC rings, ABA safety, pairwise Tell as the scaling surface. |
