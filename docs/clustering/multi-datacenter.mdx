...
![Multi-Datacenter Architecture - DC-1 and DC-2 clusters communicate via a Control Plane (NATS JetStream or etcd) for registration, heartbeats, and cross-DC messaging](/assets/multi-datacenter-architecture.png)
...
- [Clustered](/clustering/clustered) — Cluster setup and discovery
