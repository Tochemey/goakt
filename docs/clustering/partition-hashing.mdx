...
| ----------------------------- | ------------------------------------------ | -------------------------------- |
| Cluster registry partitioning | `ClusterConfig.WithPartitionHasher`        | Cluster mode only                |
| Consistent-hash routers       | `WithConsistentHashHasher` (router option) | Both standalone and cluster mode |
