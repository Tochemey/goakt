...
This guide creates an actor system, spawns an actor, and exchanges messages with it, all in one file. You need Go 1.26
or higher and nothing else; standalone mode has no external dependencies.

## Install

Create a module and add GoAkt to it:
...
The `v4` module path pins you to v4.x releases. The framework follows semantic versioning; patch releases within v4 are
backward compatible.
