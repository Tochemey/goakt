...
| `WithTLS(info)`                            | TLS for remoting and cluster transports. See [TLS](/advanced/remoting#tls).                       |
...
| **Advanced**                               |                                                                                                   |
| `WithPartitionHasher(hasher)`              | Custom partition hasher for cluster placement. See [Partition Hashing](/clustering/partition-hashing). |
