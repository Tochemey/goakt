...
| Method                | Purpose                                                                                                                                                      |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ctx.Become`          | Replace the current behavior. The current message finishes under the old behavior; subsequent messages use the new one. No stack: previous behavior is lost. |
| `ctx.BecomeStacked`   | Push a new behavior on top. Current message still uses the existing behavior; subsequent messages use the new one until `UnBecomeStacked`.                   |
