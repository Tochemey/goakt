...
| ------------------------------ | ------------------------------------------ | ---------------------------------------------------------------------------- |
| **TimeBasedStrategy**          | `passivation.NewTimeBasedStrategy`         | No message within the configured duration                                    |
| **MessagesCountBasedStrategy** | `passivation.NewMessageCountBasedStrategy` | Actor has processed at least `maxMessages` since the strategy was registered |
...
| **Config**    | `WithPassivationStrategy` at spawn | `WithEvictionStrategy` at system creation |
