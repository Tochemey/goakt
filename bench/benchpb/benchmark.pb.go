...
const file_benchmark_benchmark_proto_rawDesc = "" +
	"\n" +
	"\x19benchmark/benchmark.proto\x12\abenchpb\"\v\n" +
	"\tBenchTell\"\x0e\n" +
	"\fBenchRequest\"\x0f\n" +
	"\rBenchResponse\"\x06\n" +
	"\x04Ping\"\x06\n" +
	"\x04Pong\"2\n" +
	"\x14BenchPriorityMailbox\x12\x1a\n" +
	"\bpriority\x18\x01 \x01(\x03R\bpriorityB\x8f\x01\n" +
	"\vcom.benchpbB\x0eBenchmarkProtoH\x02P\x01Z2github.com/tochemey/goakt/v3/bench/benchpb;benchpb\xa2\x02\x03BXX\xaa\x02\aBenchpb\xca\x02\aBenchpb\xe2\x02\x13Benchpb\\GPBMetadata\xea\x02\aBenchpbb\x06proto3"
