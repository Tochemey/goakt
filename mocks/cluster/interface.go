...
func (_m *Interface) Actors(ctx context.Context, timeout time.Duration) ([]*internalpb.ActorRef, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, time.Duration) ([]*internalpb.ActorRef, error)); ok {
		return rf(ctx, timeout)
	}
	if rf, ok := ret.Get(0).(func(context.Context, time.Duration) []*internalpb.ActorRef); ok {
		r0 = rf(ctx, timeout)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Interface_Actors_Call) Return(_a0 []*internalpb.ActorRef, _a1 error) *Interface_Actors_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Interface_Actors_Call) RunAndReturn(run func(context.Context, time.Duration) ([]*internalpb.ActorRef, error)) *Interface_Actors_Call {
	_c.Call.Return(run)
	return _c
}
