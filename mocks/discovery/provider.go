...
import (
	...
	discovery "github.com/tochemey/goakt/discovery"
)
...
func (_m *Provider) SetConfig(config discovery.Config) error {
	ret := _m.Called(config)

	var r0 error
	if rf, ok := ret.Get(0).(func(discovery.Config) error); ok {
		r0 = rf(config)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Provider_SetConfig_Call) Run(run func(config discovery.Config)) *Provider_SetConfig_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(discovery.Config))
	})
	return _c
}
...
func (_c *Provider_SetConfig_Call) RunAndReturn(run func(discovery.Config) error) *Provider_SetConfig_Call {
	_c.Call.Return(run)
	return _c
}
