...
func (_mock *Provider) Close() error {
	ret := _mock.Called()
...
// Deregister provides a mock function for the type Provider
func (_mock *Provider) Deregister() error {
	ret := _mock.Called()
...
func (_c *Provider_Deregister_Call) Return(err error) *Provider_Deregister_Call {
	_c.Call.Return(err)
	return _c
}
...
// DiscoverPeers provides a mock function for the type Provider
func (_mock *Provider) DiscoverPeers() ([]string, error) {
	ret := _mock.Called()
...
func (_c *Provider_DiscoverPeers_Call) Return(strings []string, err error) *Provider_DiscoverPeers_Call {
...
// Initialize provides a mock function for the type Provider
func (_mock *Provider) Initialize() error {
	ret := _mock.Called()
...
func (_c *Provider_Initialize_Call) Return(err error) *Provider_Initialize_Call {
	_c.Call.Return(err)
	return _c
}
...
func (_mock *Provider) Register() error {
	ret := _mock.Called()
