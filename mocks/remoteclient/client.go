...
// RemoteTellGrainOneWay provides a mock function for the type Client
func (_mock *Client) RemoteTellGrainOneWay(ctx context.Context, host string, port int, grainRequest *remote.GrainRequest, message any) error {
	ret := _mock.Called(ctx, host, port, grainRequest, message)

	if len(ret) == 0 {
		panic("no return value specified for RemoteTellGrainOneWay")
	}
...
// Client_RemoteTellGrainOneWay_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoteTellGrainOneWay'
type Client_RemoteTellGrainOneWay_Call struct {
	*mock.Call
}

// RemoteTellGrainOneWay is a helper method to define mock.On call
//   - ctx context.Context
//   - host string
//   - port int
//   - grainRequest *remote.GrainRequest
//   - message any
func (_e *Client_Expecter) RemoteTellGrainOneWay(ctx any, host any, port any, grainRequest any, message any) *Client_RemoteTellGrainOneWay_Call {
	return &Client_RemoteTellGrainOneWay_Call{Call: _e.mock.On("RemoteTellGrainOneWay", ctx, host, port, grainRequest, message)}
}

func (_c *Client_RemoteTellGrainOneWay_Call) Run(run func(ctx context.Context, host string, port int, grainRequest *remote.GrainRequest, message any)) *Client_RemoteTellGrainOneWay_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *Client_RemoteTellGrainOneWay_Call) Return(err error) *Client_RemoteTellGrainOneWay_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Client_RemoteTellGrainOneWay_Call) RunAndReturn(run func(ctx context.Context, host string, port int, grainRequest *remote.GrainRequest, message any) error) *Client_RemoteTellGrainOneWay_Call {
	_c.Call.Return(run)
	return _c
}
