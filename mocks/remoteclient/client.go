...
// RemoteUnWatch provides a mock function with given fields: ctx, host, port, name, watcher
func (_m *Client) RemoteUnWatch(ctx context.Context, host string, port int, name string, watcher *address.Address) error {
	ret := _m.Called(ctx, host, port, name, watcher)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int, string, *address.Address) error); ok {
		r0 = rf(ctx, host, port, name, watcher)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Client_RemoteUnWatch_Call) Run(run func(ctx context.Context, host string, port int, name string, watcher *address.Address)) *Client_RemoteUnWatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int), args[3].(string), args[4].(*address.Address))
	})
	return _c
}

func (_c *Client_RemoteUnWatch_Call) Return(_a0 error) *Client_RemoteUnWatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_RemoteUnWatch_Call) RunAndReturn(run func(context.Context, string, int, string, *address.Address) error) *Client_RemoteUnWatch_Call {
	_c.Call.Return(run)
	return _c
}

// RemoteWatch provides a mock function with given fields: ctx, host, port, name, watcher
func (_m *Client) RemoteWatch(ctx context.Context, host string, port int, name string, watcher *address.Address) error {
	ret := _m.Called(ctx, host, port, name, watcher)
...
func (_c *Client_RemoteWatch_Call) Return(_a0 error) *Client_RemoteWatch_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_RemoteWatch_Call) RunAndReturn(run func(context.Context, string, int, string, *address.Address) error) *Client_RemoteWatch_Call {
	_c.Call.Return(run)
	return _c
}
