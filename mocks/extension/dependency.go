...
// ID provides a mock function for the type Dependency
func (_mock *Dependency) ID() string {
	ret := _mock.Called()
...
func (_c *Dependency_ID_Call) Return(s string) *Dependency_ID_Call {
	_c.Call.Return(s)
	return _c
}
...
// MarshalBinary provides a mock function for the type Dependency
func (_mock *Dependency) MarshalBinary() ([]byte, error) {
	ret := _mock.Called()
...
// UnmarshalBinary provides a mock function for the type Dependency
func (_mock *Dependency) UnmarshalBinary(data []byte) error {
...
func (_c *Dependency_UnmarshalBinary_Call) Return(err error) *Dependency_UnmarshalBinary_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *Dependency_UnmarshalBinary_Call) RunAndReturn(run func(data []byte) error) *Dependency_UnmarshalBinary_Call {
	_c.Call.Return(run)
	return _c
}
