...
import (
	...
	net "github.com/tochemey/goakt/v3/internal/net"
...
func (_m *Remoting) RemoteAskGrain(ctx context.Context, host string, port int, grainRequest *v3remote.GrainRequest, message interface{}, timeout time.Duration) (interface{}, error) {
	...
	var r0 interface{}
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int, *v3remote.GrainRequest, interface{}, time.Duration) (interface{}, error)); ok {
		return rf(ctx, host, port, grainRequest, message, timeout)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, int, *v3remote.GrainRequest, interface{}, time.Duration) interface{}); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, int, *v3remote.GrainRequest, interface{}, time.Duration) error); ok {
...
func (_c *Remoting_RemoteAskGrain_Call) Run(run func(ctx context.Context, host string, port int, grainRequest *v3remote.GrainRequest, message interface{}, timeout time.Duration)) *Remoting_RemoteAskGrain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int), args[3].(*v3remote.GrainRequest), args[4].(interface{}), args[5].(time.Duration))
	})
	return _c
}
...
func (_c *Remoting_RemoteAskGrain_Call) RunAndReturn(run func(context.Context, string, int, *v3remote.GrainRequest, interface{}, time.Duration) (interface{}, error)) *Remoting_RemoteAskGrain_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Remoting) RemoteTellGrain(ctx context.Context, host string, port int, grainRequest *v3remote.GrainRequest, message interface{}) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int, *v3remote.GrainRequest, interface{}) error); ok {
...
func (_c *Remoting_RemoteTellGrain_Call) Run(run func(ctx context.Context, host string, port int, grainRequest *v3remote.GrainRequest, message interface{})) *Remoting_RemoteTellGrain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(int), args[3].(*v3remote.GrainRequest), args[4].(interface{}))
	})
	return _c
}
...
func (_c *Remoting_RemoteTellGrain_Call) RunAndReturn(run func(context.Context, string, int, *v3remote.GrainRequest, interface{}) error) *Remoting_RemoteTellGrain_Call {
	_c.Call.Return(run)
	return _c
}

// Serializer provides a mock function with given fields: msg
func (_m *Remoting) Serializer(msg interface{}) v3remote.Serializer {
	ret := _m.Called(msg)
	...
	var r0 v3remote.Serializer
	if rf, ok := ret.Get(0).(func(interface{}) v3remote.Serializer); ok {
		r0 = rf(msg)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(v3remote.Serializer)
		}
	}
...
func (_c *Remoting_Serializer_Call) Return(_a0 v3remote.Serializer) *Remoting_Serializer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Remoting_Serializer_Call) RunAndReturn(run func(interface{}) v3remote.Serializer) *Remoting_Serializer_Call {
	_c.Call.Return(run)
	return _c
}
