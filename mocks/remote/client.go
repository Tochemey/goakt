...
func (_m *Client) Compression() v4remote.Compression {
	ret := _m.Called()
...
func (_c *Client_Compression_Call) Return(_a0 v4remote.Compression) *Client_Compression_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_Compression_Call) RunAndReturn(run func() v4remote.Compression) *Client_Compression_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) RemoteActivateGrain(ctx context.Context, host string, port int, grainRequest *v4remote.GrainRequest) error {
...
func (_c *Client_RemoteActivateGrain_Call) Run(run func(ctx context.Context, host string, port int, grainRequest *v4remote.GrainRequest)) *Client_RemoteActivateGrain_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_RemoteActivateGrain_Call) RunAndReturn(run func(context.Context, string, int, *v4remote.GrainRequest) error) *Client_RemoteActivateGrain_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) RemoteAskGrain(ctx context.Context, host string, port int, grainRequest *v4remote.GrainRequest, message interface{}, timeout time.Duration) (interface{}, error) {
...
func (_c *Client_RemoteAskGrain_Call) Run(run func(ctx context.Context, host string, port int, grainRequest *v4remote.GrainRequest, message interface{}, timeout time.Duration)) *Client_RemoteAskGrain_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_RemoteAskGrain_Call) RunAndReturn(run func(context.Context, string, int, *v4remote.GrainRequest, interface{}, time.Duration) (interface{}, error)) *Client_RemoteAskGrain_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) RemoteSpawn(ctx context.Context, host string, port int, spawnRequest *v4remote.SpawnRequest) error {
...
func (_c *Client_RemoteSpawn_Call) Run(run func(ctx context.Context, host string, port int, spawnRequest *v4remote.SpawnRequest)) *Client_RemoteSpawn_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_RemoteSpawn_Call) RunAndReturn(run func(context.Context, string, int, *v4remote.SpawnRequest) error) *Client_RemoteSpawn_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Client) RemoteTellGrain(ctx context.Context, host string, port int, grainRequest *v4remote.GrainRequest, message interface{}) error {
...
func (_c *Client_RemoteTellGrain_Call) Run(run func(ctx context.Context, host string, port int, grainRequest *v4remote.GrainRequest, message interface{})) *Client_RemoteTellGrain_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Client_RemoteTellGrain_Call) RunAndReturn(run func(context.Context, string, int, *v4remote.GrainRequest, interface{}) error) *Client_RemoteTellGrain_Call {
	_c.Call.Return(run)
	return _c
}

// Serializer provides a mock function with given fields: msg
func (_m *Client) Serializer(msg interface{}) v4remote.Serializer {
	ret := _m.Called(msg)
...
func (_c *Client_Serializer_Call) Return(_a0 v4remote.Serializer) *Client_Serializer_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Client_Serializer_Call) RunAndReturn(run func(interface{}) v4remote.Serializer) *Client_Serializer_Call {
	_c.Call.Return(run)
	return _c
}
