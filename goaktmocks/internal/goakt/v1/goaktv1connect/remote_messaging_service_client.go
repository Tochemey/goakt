...
type mockConstructorTestingTNewRemoteMessagingServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRemoteMessagingServiceClient(t mockConstructorTestingTNewRemoteMessagingServiceClient) *RemoteMessagingServiceClient {
